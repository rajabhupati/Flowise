...
class LlmGateway_LLMs implements INode {
    label: string
    name: string
    version: number
    type: string
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const obj: Partial<AzureOpenAIInput> & BaseLLMParams & Partial<OpenAIInput> & { llmgateway?: LlmGatewayConfig } = {
...
module.exports = { nodeClass: LlmGateway_LLMs }
